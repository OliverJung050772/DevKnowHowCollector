#pragma checksum "/home/oliver/Dokumente/Git-Repos/DevKnowHowCollector/DKHC-Client/Pages/Register.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c4934ad8a393ba36a8d4cd70b1e0dde8f14394b2"
// <auto-generated/>
...
#line 68 "/home/oliver/Dokumente/Git-Repos/DevKnowHowCollector/DKHC-Client/Pages/Register.razor"
    ...
    private async void RegisterButtonClicked()
    {
        if (FormIsValid())
        {
            ...
            if (ApiService.SaveNewMemberAsync(newMember) != null)
            {
                Console.WriteLine("Registered new member " + newMember.FirstName 
                    + " " + newMember.LastName + " successfully!");
            }
            else
            {
