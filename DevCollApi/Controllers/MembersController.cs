...
namespace DevCollApi.Controllers
{
    ...
    public class MembersController : ControllerBase
    {
        ...
        public MembersController(DevCollectContext context)
        {
            _context = context;
        }
        ...
        {
            var listSortedByName = await _context.Members.OrderBy(member => member.LastName).ToListAsync();
        ...
        */
        ...
        {
            return _context.Members.Any(e => e.MembId == id);
        }
    }
}
